...
namespace E_commerce.Repository.Orders
{
    public class IE_commerceOrdersRepository : IOrderInterface
    {
        ...
        private readonly IUserValidationClient _userValidationClient;

        public IE_commerceOrdersRepository(E_commerceDB context, IUserValidationClient userValidationClient)
        {
            _context = context;
        ...
        public async Task<Order> CreateOrder(CreateOrderDtos createOrderDtos)
        {
            ...
            await EnsureUserExistsAsync(createOrderDtos.UserId);
        ...
        {
            var exists = await _userValidationClient.UserExistsAsync(userId);
